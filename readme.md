...
CORS anda detrás de nosotros... si no funciona la aplicación recordad que puede ser por un problema de CORS, abramos el inspector para ver los fallos y adelantémonos a ellos.
